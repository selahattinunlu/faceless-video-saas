        ...
        <div className="w-full max-w-2xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
              Fikirden Videoya, <br/>
              <span className="text-indigo-400">Saniyeler İçinde.</span>
            </h2>
            <p className="text-muted-foreground text-lg">
              İstediğin konuyu yaz, yapay zeka senin için senaryoyu yazsın, görselleri üretsin ve seslendirsin.
            </p>
          </div>
              ...
              <div className="lg:w-2/3 order-2 lg:order-1">
                <div className="flex justify-between items-end mb-6">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {scenes.filter(s => s.status === 'complete').length} / {scenes.length} Hazır
                  </span>
                </div>
